				...
				>
					<motion.div variants={fadeIn('down', 0.2)} className="text-center mb-12">
						...
						<p className="text-lg text-muted-foreground max-w-2xl mx-auto">
							Uma visão completa das minhas habilidades técnicas, do meu domínio de softwares,
							das minhas competências comportamentais e dos idiomas que utilizo.
						</p>
					</motion.div>
